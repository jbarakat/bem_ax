...
#endif
#endif
static void ATL_zJIK0x0x39TN1x1x2_a1_bX
 ...
 * lda=39, ldb=39, ldc=0, mu=1, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   #define incAk 2
   const int incAm = 1, incAn = -(39*(Mb));
   #define incBk 2
   const int incBm = -38, incBn = 39;
   #define incCm 2
   ...
   do /* N-loop */
   {
      do /* M-loop */
      {
         ...
         rC0_0 = *pC0;
         rC0_0 *= rA0;
         for (k=0; k < 19; k++) /* easy loop to unroll */
         {
            rA0 = *pA0;
            rB0 = *pB0;
            rC0_0 += rA0 * rB0;
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=39, 
 * lda=39, ldb=39, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const double *stN = B + (39*(Nb));
   #define incAk 2
   const int incAm = 430, incAn = -(39*(Mb));
   #define incBk 2
   const int incBm = -38, incBn = 39;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x39TN1x1x2_a1_bX(k, N, 39, alpha, ca + (39*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
