...
#endif
#endif
static void ATL_zJIK0x0x15TN1x1x2_a1_bX
 ...
 * lda=15, ldb=15, ldc=0, mu=1, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   #define incAk 2
   const int incAm = 1, incAn = -(15*(Mb));
   #define incBk 2
   const int incBm = -14, incBn = 15;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=15, 
 * lda=15, ldb=15, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const double *stN = B + (15*(Nb));
   #define incAk 2
   const int incAm = 166, incAn = -(15*(Mb));
   #define incBk 2
   const int incBm = -14, incBn = 15;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x15TN1x1x2_a1_bX(k, N, 15, alpha, ca + (15*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
