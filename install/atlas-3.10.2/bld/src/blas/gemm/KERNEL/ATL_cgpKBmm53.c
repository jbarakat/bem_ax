...
static void ATL_cJIK0x0x53TN1x1x8_a1_bX
 ...
 * lda=53, ldb=53, ldc=0, mu=1, nu=1, ku=8, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=53, 
 * lda=53, ldb=53, ldc=0, mu=12, nu=1, ku=8, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x53TN1x1x8_a1_bX(k, N, 53, alpha, ca + (53*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
