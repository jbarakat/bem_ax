...
#endif
#endif
static void ATL_zJIK0x0x50TN1x1x2_a1_bX
 ...
 * lda=50, ldb=50, ldc=0, mu=1, nu=1, ku=2, pf=0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=50, 
 * lda=50, ldb=50, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const double *stN = B + (50*(Nb));
   #define incAk 2
   const int incAm = 550, incAn = -(50*(Mb));
   #define incBk 2
   const int incBm = -50, incBn = 50;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x50TN1x1x2_a1_bX(k, N, 50, alpha, ca + (50*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
