...
#endif
#endif
static void ATL_zJIK0x0x36TN1x1x2_a1_bX
 ...
 * lda=36, ldb=36, ldc=0, mu=1, nu=1, ku=2, pf=0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=36, 
 * lda=36, ldb=36, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x36TN1x1x2_a1_bX(k, N, 36, alpha, ca + (((Mb) << 5)+((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
