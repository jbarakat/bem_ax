...
static void ATL_dJIK0x0x42TN1x1x2_a1_bX
 ...
 * lda=42, ldb=42, ldc=0, mu=1, nu=1, ku=2, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=42, 
 * lda=42, ldb=42, ldc=0, mu=12, nu=1, ku=2, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x42TN1x1x2_a1_bX(k, N, 42, alpha, ca + (42*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
