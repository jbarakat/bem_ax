...
static void ATL_cJIK0x0x48TN1x1x8_a1_bX
 ...
 * lda=48, ldb=48, ldc=0, mu=1, nu=1, ku=8, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=48, 
 * lda=48, ldb=48, ldc=0, mu=12, nu=1, ku=8, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x48TN1x1x8_a1_bX(k, N, 48, alpha, ca + (((Mb) << 5)+((Mb) << 4)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
