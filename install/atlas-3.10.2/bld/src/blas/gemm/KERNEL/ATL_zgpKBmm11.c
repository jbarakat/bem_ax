...
#endif
#endif
static void ATL_zJIK0x0x11TN1x1x2_a1_bX
 ...
 * lda=11, ldb=11, ldc=0, mu=1, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   #define incAk 2
   const int incAm = 1, incAn = -(11*(Mb));
   #define incBk 2
   const int incBm = -10, incBn = 11;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=11, 
 * lda=11, ldb=11, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const double *stN = B + (11*(Nb));
   #define incAk 2
   const int incAm = 122, incAn = -(11*(Mb));
   #define incBk 2
   const int incBm = -10, incBn = 11;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x11TN1x1x2_a1_bX(k, N, 11, alpha, ca + (11*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
