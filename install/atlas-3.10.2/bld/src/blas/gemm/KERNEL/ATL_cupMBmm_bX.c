...
#define ATL_CupMBmm0_4_0_bX(M_, N_, K_, al_, A_, lda_, B_, ldb_, be_, C_, ldc_) \
{ \
   ATL_cupMBmm0_4_0_bX(M_, N_, K_, al_, A_, lda_, B_, ldb_, -(be_), C_, ldc_); \
   ATL_cupMBmm0_4_0_bX(M_, N_, K_, al_, A_, lda_, (B_)+(ldb_)*(N_), ldb_, be_, (C_)+1, ldc_); \
