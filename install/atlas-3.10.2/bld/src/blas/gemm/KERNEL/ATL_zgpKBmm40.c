...
#endif
#endif
static void ATL_zJIK0x0x40TN1x1x2_a1_bX
 ...
 * lda=40, ldb=40, ldc=0, mu=1, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   do /* N-loop */
   {
      do /* M-loop */
      {
         ...
         rC0_0 = *pC0;
         rC0_0 *= rA0;
         for (k=0; k < 20; k++) /* easy loop to unroll */
         {
            rA0 = *pA0;
            rB0 = *pB0;
            rC0_0 += rA0 * rB0;
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=40, 
 * lda=40, ldb=40, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x40TN1x1x2_a1_bX(k, N, 40, alpha, ca + (((Mb) << 5)+((Mb) << 3)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
