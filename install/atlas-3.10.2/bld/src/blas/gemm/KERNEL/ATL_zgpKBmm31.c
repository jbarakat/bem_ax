...
#endif
#endif
static void ATL_zJIK0x0x31TN1x1x2_a1_bX
 ...
 * lda=31, ldb=31, ldc=0, mu=1, nu=1, ku=2, pf=0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=31, 
 * lda=31, ldb=31, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x31TN1x1x2_a1_bX(k, N, 31, alpha, ca + (31*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
