...
#define ATL_ZupMBmm0_1_0_b0(M_, N_, K_, al_, A_, lda_, B_, ldb_, be_, C_, ldc_) \
{ \
   ATL_zupMBmm0_1_0_b0(M_, N_, K_, al_, A_, lda_, B_, ldb_, ATL_rzero, C_, ldc_); \
   ATL_zupMBmm0_1_0_b0(M_, N_, K_, al_, A_, lda_, (B_)+(ldb_)*(N_), ldb_, be_, (C_)+1, ldc_); \
    ...
    const double beta, double *C, const int ldc)
{
   ...
   {
      ATL_ZupMBmm0_1_0_b0(M, N, K, alpha, A, lda, B, ldb, beta, C, ldc);
   }
}
