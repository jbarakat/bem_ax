...
#endif
#endif
static void ATL_zJIK0x0x7TN1x1x2_a1_bX
 ...
 * lda=7, ldb=7, ldc=0, mu=1, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   #define incAk 2
   const int incAm = 1, incAn = -(7*(Mb));
   #define incBk 2
   const int incBm = -6, incBn = 7;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=7, 
 * lda=7, ldb=7, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x7TN1x1x2_a1_bX(k, N, 7, alpha, ca + (7*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
