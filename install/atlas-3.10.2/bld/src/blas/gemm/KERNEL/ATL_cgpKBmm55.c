...
static void ATL_cJIK0x0x55TN1x1x8_a1_bX
 ...
 * lda=55, ldb=55, ldc=0, mu=1, nu=1, ku=8, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=55, 
 * lda=55, ldb=55, ldc=0, mu=12, nu=1, ku=8, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 8
   const int incAm = 612, incAn = -(55*(Mb));
   #define incBk 8
   const int incBm = -48, incBn = 55;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x55TN1x1x8_a1_bX(k, N, 55, alpha, ca + (55*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
