...
#endif
#endif
static void ATL_zJIK0x0x10TN1x1x2_a1_bX
 ...
 * lda=10, ldb=10, ldc=0, mu=1, nu=1, ku=2, pf=0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=10, 
 * lda=10, ldb=10, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x10TN1x1x2_a1_bX(k, N, 10, alpha, ca + (((Mb) << 3)+((Mb) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
