...
#endif
#endif
static void ATL_zJIK0x0x23TN1x1x2_a1_bX
 ...
 * lda=23, ldb=23, ldc=0, mu=1, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   #define incAk 2
   const int incAm = 1, incAn = -(23*(Mb));
   #define incBk 2
   const int incBm = -22, incBn = 23;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=23, 
 * lda=23, ldb=23, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const double *stN = B + (23*(Nb));
   #define incAk 2
   const int incAm = 254, incAn = -(23*(Mb));
   #define incBk 2
   const int incBm = -22, incBn = 23;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x23TN1x1x2_a1_bX(k, N, 23, alpha, ca + (23*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
