...
#endif
#endif
static void ATL_zJIK0x0x55TN1x1x2_a1_bX
 ...
 * lda=55, ldb=55, ldc=0, mu=1, nu=1, ku=2, pf=0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=55, 
 * lda=55, ldb=55, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x55TN1x1x2_a1_bX(k, N, 55, alpha, ca + (55*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
