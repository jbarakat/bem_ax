...
#endif
#endif
static void ATL_zJIK0x0x41TN1x1x2_a1_bX
 ...
 * lda=41, ldb=41, ldc=0, mu=1, nu=1, ku=2, pf=0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=41, 
 * lda=41, ldb=41, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x41TN1x1x2_a1_bX(k, N, 41, alpha, ca + (41*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
