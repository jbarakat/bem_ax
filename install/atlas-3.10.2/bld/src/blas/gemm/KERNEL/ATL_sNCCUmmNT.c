...
#endif
#endif
static void ATL_sJIK0x0x0NT1x1x16_aX_bX
 ...
 */
{
   ...
   do /* N-loop */
   {
      do /* M-loop */
      {
         ...
         rC0_0 = *pC0;
         rC0_0 *= rA0;
         for (k=0; k < Kb; k += 16) /* easy loop to unroll */
         {
            rA0 = *pA0;
            rB0 = *pB0;
            rC0_0 += rA0 * rB0;
...
/*
 * matmul with TA=N, TB=T, MB=0, NB=0, KB=0, 
 * lda=0, ldb=0, ldc=0, mu=12, nu=1, ku=16, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_sJIK0x0x0NT1x1x16_aX_bX(k, N, K, alpha, ca + (Mb), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
