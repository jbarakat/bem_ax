...
static void ATL_cJIK0x0x38TN1x1x8_a1_bX
 ...
 * lda=38, ldb=38, ldc=0, mu=1, nu=1, ku=8, pf=1
 ...
 */
{
   ...
   #define incAk 8
   const int incAm = 6, incAn = -(38*(Mb));
   #define incBk 8
   const int incBm = -32, incBn = 38;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=38, 
 * lda=38, ldb=38, ldc=0, mu=12, nu=1, ku=8, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 8
   const int incAm = 424, incAn = -(38*(Mb));
   #define incBk 8
   const int incBm = -32, incBn = 38;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x38TN1x1x8_a1_bX(k, N, 38, alpha, ca + (38*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
