...
#endif
#endif
static void ATL_zJIK0x0x34TN1x1x2_a1_bX
 ...
 * lda=34, ldb=34, ldc=0, mu=1, nu=1, ku=2, pf=0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=34, 
 * lda=34, ldb=34, ldc=0, mu=12, nu=1, ku=2, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   const double *stN = B + (((Nb) << 5)+((Nb) << 1));
   #define incAk 2
   const int incAm = 374, incAn = -(((Mb) << 5)+((Mb) << 1));
   #define incBk 2
   const int incBm = -34, incBn = 34;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x34TN1x1x2_a1_bX(k, N, 34, alpha, ca + (((Mb) << 5)+((Mb) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
