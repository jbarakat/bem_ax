...
#endif
#endif
static void ATL_zJIK8x0x56TN8x1x2_a1_bX
 ...
 * lda=56, ldb=56, ldc=0, mu=8, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   do /* N-loop */
   {
      ...
      rC7_0 = pC0[14];
      rC7_0 *= rA0;
      for (k=0; k < 28; k++) /* easy loop to unroll */
      {
         rA0 = *pA0;
         rB0 = *pB0;
         rA1 = pA0[56];
 ...
 */
{
   ...
   while(pB0 != stN);
   ATL_zJIK8x0x56TN8x1x2_a1_bX(8, N, 56, alpha, ca + 2688, lda, cb, ldb, beta, cc + 96, ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_zJIK8x0x56TN8x1x2_a1_b1
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=8, NB=0, KB=56, 
 * lda=56, ldb=56, ldc=0, mu=8, nu=1, ku=2, pf=0
 ...
 */
{
   ...
   while(pB0 != stN);
   ATL_zJIK8x0x56TN8x1x2_a1_b1(8, N, 56, alpha, ca + 2688, lda, cb, ldb, beta, cc + 96, ldc);
}
#ifdef incAm
   #undef incAm
#endif
