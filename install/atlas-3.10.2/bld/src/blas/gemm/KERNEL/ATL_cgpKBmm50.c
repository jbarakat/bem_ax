...
static void ATL_cJIK0x0x50TN1x1x8_a1_bX
 ...
 * lda=50, ldb=50, ldc=0, mu=1, nu=1, ku=8, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=50, 
 * lda=50, ldb=50, ldc=0, mu=12, nu=1, ku=8, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.2)
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x50TN1x1x8_a1_bX(k, N, 50, alpha, ca + (50*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
