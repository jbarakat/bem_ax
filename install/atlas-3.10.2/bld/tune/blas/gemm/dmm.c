...
static void ATL_dJIK8x0x56TN8x1x2_a1_b1
 ...
 * lda=56, ldb=56, ldc=0, mu=8, nu=1, ku=2, pf=1
 ...
 */
{
   ...
   while(pB0 != stN);
   ATL_dJIK8x0x56TN8x1x2_a1_b1(8, N, 56, alpha, ca + 2688, lda, cb, ldb, beta, cc + 48, ldc);
}
#ifdef incAm
   #undef incAm
#endif
